...
public class SynchronousConcurrency {
	public static void main(String[] args) throws Exception {
		...
		queue.put(EOF);
		writerThread.join();
		// AtomicLong is not needed here due to memory barrier created by thread
		// join, but still need a mutable long since lineCount must be final to
		// access it from an anonymous class
