...
If it exists then print its path. All move­ments are allowed (right, left, up, down and diagonally).
...
5. If above cri­te­ria matches, mark that cell with a num­ber When­ever any cell matches with the cri­te­ria, 
	...
	5.1 Now try to solve rest of the prob­lem recur­sively by mak­ing index +1. Check all 8 direc­tions 
	( up, down, left right, diag­o­nally up-left, diag­o­nally up-right, diag­o­nally down-left, diag­o­nally down-right). 
	Check the bound­ary con­di­tions as well
	5.2 If none of the 8 recur­sive calls return true, BACKTRACK and undo the changes 
...
public class WordSearchIn2DMatrix {
		...
		public static void main(String[] args) {
			...
			w = new WordSearchIn2DMatrix(matrix.length);
			howmanytimessearchiscalled = 0;
			if (w.searchWord(matrix, "howon")) {
				w.print();
			} else {
				System.out.println("NO PATH FOUND");
			}
